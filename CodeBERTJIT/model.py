...
from transformers import  RobertaConfig, RobertaForSequenceClassification,  RobertaModel, BertModel,AutoTokenizer,AutoModelForSequenceClassification
...
class  CodeBERT4JIT(nn.Module):
	...
	# CodeBERT model
        ...
        # self.roberta_encoder= RobertaModel.from_pretrained("roberta-base", num_labels = args.class_num)
        # self.vul_encoder=model = AutoModelForSequenceClassification.from_pretrained('mrm8488/codebert-base-finetuned-detect-insecure-code')
