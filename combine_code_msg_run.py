...
def RoBERTa_model(params):
    ...
    if params.test:
        ...
        test_pre = "CUDA_VISIBLE_DEVICES=0 python combine_code_msg_main.py -code_type {} -predict -pred_data config_dataset/data/{}/cc2vec/{}_test.pkl  -dictionary_data config_dataset/data/{}/cc2vec/{}_dict.pkl -load_model combine_snapshot/{}/code_{}_msg_None/{}/"
        projects = ['qt', 'openstack', 'jdt', 'platform', 'gerrit', 'go']
        # projects=['jdt']
        # sub = ['cv0','cv1', 'cv2', 'cv3', 'cv4']
        code_type=['None','RNN','Transformer','CNN']
