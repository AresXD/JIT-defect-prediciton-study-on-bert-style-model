...
def train_model(data, params):
    ...
    Adam_optimizer=optimizer = torch.optim.Adam(model.parameters(), lr=params.l2_reg_lambda,weight_decay=params.weight_decay)
    SGD_optimizer = torch.optim.SGD(model.parameters(), lr=params.l2_reg_lambda,weight_decay=params.weight_decay,momentum=params.momentum)
