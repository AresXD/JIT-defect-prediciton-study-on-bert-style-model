...
import pickle
import numpy as np
from config_test import evaluation_model
...
def read_args():
    ...
    parser.add_argument('-momentum', type=float, default=0.9, help='batch size')
    ...
    parser.add_argument('-save_loss_path', type=str, default='tmp.csv', help='how many steps to save the model')
    parser.add_argument('-get_different_loss', action='store_true')
...
if __name__ == '__main__':
    ...
    if params.train is True:
        ...
        if params.weight:
            ...
            print(
                'Test data at Threshold 0.5 -- AUc: %.2f Accuracy: %.2f, False Positives: %.2f, Precision: %.2f, Recall: %.2f' % (auc,
                     A, E, P, R))
